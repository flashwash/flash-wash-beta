...
function MaterialBottomTabViewInner(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_reactNativePaper.BottomNavigation, _extends({}, rest, {
    ...
    onIndexChange: index => navigation.dispatch(_objectSpread(_objectSpread({}, _native.TabActions.jumpTo(state.routes[index].name)), {}, {
      target: state.key
    })),
    renderScene: ({
      route
    }) => descriptors[route.key].render(),
    renderTouchable: _reactNative.Platform.OS === 'web' ? (_ref2) => {
      let {
        onPress: _onPress,
        route,
    ...
    renderIcon: ({
      ...
      if (typeof options.tabBarIcon === 'string') {
        return /*#__PURE__*/React.createElement(_MaterialCommunityIcons.default, {
